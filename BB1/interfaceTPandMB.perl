...
my %command = ( 
 ...
 otter   => "otter < otter.in > otter.out & echo otter > otter.ready",
 bliksem => "bliksem < bliksem.in > bliksem.out & echo bliksem > bliksem.ready",
 mace    => "mace -t20 -n1 -N$domainsize -P < mace.in > mace.out & echo mace > mace.ready",
 paradox => "paradox paradox.in --sizes 1..$domainsize --print Model > paradox.out 2>> log.txt & echo paradox > paradox.ready"
);
